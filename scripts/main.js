	...
	if(jeu) // Si jeu en route
	{
		if(!coups[caseY][caseX]) // Si pas déjà quelque chose sur la meme case
		{
			if(joueurActuel)
			{
                ...
                var temp = "croix";
                document.getElementById("joueur").innerHTML = "Au tour de Saitama";
			}
			else
			{
                ...
                var temp = "rond";
				document.getElementById("joueur").innerHTML = "Au tour de Goku";
			}
			...
			if(gain(temp,caseY,caseX))
			{
				if(joueurActuel)
				{
                    document.getElementById("resultat").innerHTML = "Victoire pour Saitama !" ;
				...
				{
                    document.getElementById("resultat").innerHTML = "Victoire pour Goku !" ;
                    document.getElementById("joueur").innerHTML = "";
					jeu = false ;
					document.getElementById("rejouer").style.display = "initial";
				}
